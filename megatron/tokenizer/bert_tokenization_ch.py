...
class FullTokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=True, jieba_dict_path=None):
        ...
        self.basic_tokenizer = JiebaBasicTokenizer(do_lower_case=do_lower_case, jieba_dict_path=jieba_dict_path)
...
class JiebaBasicTokenizer(object):
    ...
    def __init__(self, do_lower_case=True, never_split=None, jieba_dict_path=None,
    ...
    def tokenize_old_2(self, text, never_split=None, with_info=False): #, never_split=None, with_info=False, **kwargs):
