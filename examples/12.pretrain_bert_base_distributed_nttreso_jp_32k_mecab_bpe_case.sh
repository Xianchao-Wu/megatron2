...
CHECKPOINT_PATH_IN=/workspace/megatron/ngc_models/release_bert_base_cased_nttreso_jp_32k_mecab_bpe
CHECKPOINT_PATH_OUT=/workspace/megatron/ngc_models/release_bert_base_cased_nttreso_jp_32k_mecab_bpe
