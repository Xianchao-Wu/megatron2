...
#CHECKPOINT_PATH=<Specify path>
#CHECKPOINT_PATH_IN=/workspace/megatron/ngc_models/release_bert_345m_uncased_small
CHECKPOINT_PATH_IN=/workspace/megatron/ngc_models/release_bert_345m_uncased
CHECKPOINT_PATH_OUT=/workspace/megatron/ngc_models/release_bert_345m_uncased_big
